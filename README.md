...
- [UML in OSS](http://oss.models-db.com/) ([temporary mirror](http://models.cs.chalmers.se/oss/)) - More than 93,000 UML files (collected from more than 24,000 GitHub repositories).
